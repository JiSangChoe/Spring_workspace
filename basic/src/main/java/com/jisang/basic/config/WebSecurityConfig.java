...
import com.jisang.basic.filter.JwtAuthenticationFilter;
import com.jisang.basic.provider.OAuth2SuccessHandler;
import com.jisang.basic.service.implement.OAuth2UserServiceImplement;
...
public class WebSecurityConfig {
    ...
    protected SecurityFilterChain configure(HttpSecurity security) throws Exception {
        ...
        // cookie :
        // - 웹 애플리케이션에서 사용자의 대한 정보 및 상태를 유지하기 위한 기술
        // - 클라이언트측에서 사용자의 정보 및 상태를 저장하는 방법
        //*session과 cookie의 차이:
        ...
        // SQL Injection :
        // - 굥격자가 데이터베이스의 쿼리문을 직접 조작하여 데이터를 탈취하는 공격
